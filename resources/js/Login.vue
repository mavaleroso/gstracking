        ...
        <div class="d-flex flex-column flex-root">
            ...
            >
                ...
                <div
                    ...
                    style="background-repeat:no-repeat;background-position: bottom;background-image: url(assets/media/svg/illustrations/login-visual-1.svg)"
                >
                    ...
                    >
                        ...
                        <!--begin::Aside title-->
                        <h3
                            class="font-weight-bolder text-center display5 pb-lg-0 pb-40"
                        >
                            GS Tracking <br />General Services Tracking System
                        </h3>
                        <!--end::Aside title-->
                    </div>
                    <!--end::Aside Container-->
                ...
                >
                    <!--begin::Content body-->
                    <div
                        class="d-flex flex-column-fluid flex-center mt-6 mt-lg-0"
                    >
                        <!--begin::Signin-->
                        <div class="login-form login-signin">
                            ...
                            >
                                ...
                                <!--begin::Form group-->
                                <div
                                    class="alert alert-custom alert-danger p-2 pl-5"
                                    role="alert"
                                ...
                                <div class="pb-lg-0 pb-10">
                                    <button
                                        type="button"
                                        id="login-btn"
                                        class="btn btn-primary font-weight-bolder font-size-h6 py-4 my-3 mr-3"
                                        @click="login"
                                        @keyup.enter="login"
                                    >
                                        Sign In
                        ...
                        <div class="login-form login-forgot">
                            ...
                            >
                                <!--begin::Title-->
                                <div
                                    class="text-center pt-lg-40 mt-lg-20 pb-15"
                                >
                                    <p
                                ...
                                <!--begin::Form group-->
                                <div
                                    class="form-group d-flex flex-wrap flex-center pb-lg-0"
                                >
                                    <button
                                        type="button"
                    ...
                    <div
                        class="d-flex justify-content-lg-start justify-content-center flex-column-fluid align-items-end pb-2 pt-lg-0"
                    >
                        <a
                            href="#"
