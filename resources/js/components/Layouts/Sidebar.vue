    ...
    >
        ...
        <div class="brand flex-column-auto" id="kt_brand">
            ...
            <a href="#" class="brand-logo">
                <img alt="Logo" src="assets/media/logos/logo-gstracking.png" />
            </a>
            ...
            >
                ...
                <ul class="menu-nav">
                    ...
                    >
                        ...
                        >
                            <span class="svg-icon menu-icon"
                                ><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Text\Bullet-list.svg--><svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px"
                                    height="24px"
                                ...
                                ><!--end::Svg Icon--></span
                            >
                            <span class="menu-text">Local Requests</span>
                        </router-link>
                    </li>
                    <li
                        class="menu-item menu-item-submenu"
                    ...
                    >
                        ...
                        >
                            <span class="svg-icon menu-icon"
                                ...
                                ><!--end::Svg Icon--></span
                            >
                            <span class="menu-text">RITO Requests</span>
                        </router-link>
                    </li>
                    <li class="menu-section">
                    ...
                    >
                        ...
                        >
                            <span class="svg-icon menu-icon"
                                ...
                                ><!--end::Svg Icon--></span
                            >
                            <span class="menu-text">Travels Status</span>
                        </router-link>
                    </li>
                    <li
                        class="menu-item menu-item-submenu"
                    ...
                    >
                        ...
                        >
                            <span class="svg-icon menu-icon"
                                ...
                                ><!--end::Svg Icon--></span
                            >
                            <span class="menu-text">Vehicle Travels</span>
                        </router-link>
                    </li>
                    <li
                        class="menu-item menu-item-submenu"
                    ...
                    >
                        ...
                        >
                            <span class="svg-icon menu-icon"
                                ...
                                ><!--end::Svg Icon--></span
                            >
                            <span class="menu-text">Travel Calendar</span>
                        </router-link>
                    </li>
                    <li
                        id="dropdown-transpo"
                    ...
                    >
                        ...
                        >
                            <span class="svg-icon menu-icon"
                                ><!--begin::Svg Icon | path:C:\wamp64\www\keenthemes\themes\metronic\theme\html\demo1\dist/../src/media/svg/icons\Home\Commode2.svg--><svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink"
                                    width="24px"
                                    height="24px"
                                ...
                                ><!--end::Svg Icon--></span
                            >
                            <span class="menu-text">Fuel Charges</span>
                        </router-link>
                    </li>
                    <li
                        class="menu-item menu-item-submenu"
                    ...
                    >
                        ...
                        >
                            <span class="svg-icon menu-icon"
                                ...
                                ><!--end::Svg Icon--></span
                            >
                            <span class="menu-text">List of PO</span>
                        </router-link>
                    </li>
                    <li class="menu-section">
...
export default {
    ...
    methods: {
        ...
        active(type = null) {
            type == "menu"
                ? $("#dropdown-transpo").removeClass("menu-item-open")
                : null;
