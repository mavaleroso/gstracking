<template>
    <div id="rito-requests-page" class="h-100 v-100">
        <!--begin::Card-->
        <div
            class="card card-custom card-stretch animate__animated animate__fadeIn"
        ...
        <modal :id="modal.approved_id">
            ...
            <template v-slot:body>
                <form id="rito-form" class="form">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="btn font-weight-bold btn-primary mr-2">
                                Request
                                <span class="label label-sm label-white ml-2">{{
                                    selected.length
                                }}</span>
                            </div>
                            <div class="btn font-weight-bold btn-primary mr-2">
                    ...
                    <div v-if="vehicle_type == 1" class="row">
                        <label class="h5 col-lg-12">{{
                            vehiclemodes.filter(i => i.id == vehicle_type)[0]
                                .name
                        }}</label>
                        ...
                        <div class="col-lg-12 d-flex">
                            ...
                            <div class="ml-auto">
                                <button
                                    ...
                                    @click="incrementRpVehicle"
                                >
                                    <i class="fa fa-plus-square p-0"></i>
                                </button>
                                <button
                                    class="btn btn-sm btn-outline-primary"
                                    @click="decrementRpVehicle"
                                >
                    ...
                    <div v-if="vehicle_type == 4" class="col-lg-12 row">
                        <div class="col-lg-12 d-flex">
                            ...
                            <div class="ml-auto">
                                <button
                                    class="btn btn-sm btn-outline-primary"
                                    @click="incrementHiredlVehicle"
                                >
                                    <i class="fa fa-plus-square p-0"></i>
                                </button>
                                <button
                                    class="btn btn-sm btn-outline-primary"
                                    @click="decrementHiredVehicle"
                                >
                                    <i class="fa fa-minus-square p-0"></i>
                                </button>
                            </div>
...
export default {
    ...
    methods: {
        ...
        approved() {
            ...
            axios
                .post(BASE_URL + "/travel/ritorequest", ritoData)
                .then(response => {
                    $(".invalid-feedback").remove();
                    $(".invalid").removeClass("is-invalid");
