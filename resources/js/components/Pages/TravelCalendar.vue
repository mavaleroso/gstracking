    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <div
                        v-if="vehicle.office.length"
                        class="accordion accordion-solid accordion-toggle-plus"
                        id="accordion-office"
                    >
                        <div
                            class="card"
                            v-for="v in vehicle.officeData"
                            :key="v.id"
                        >
                            <div class="card-header" :id="'headingOne' + v.id">
                                ...
                                >
                                    ...
                                    {{ v.name }}
                                    <span
                                        class="mt-0 mb-0 ml-5 label label-primary label-inline"
                                        >{{ v.plate_no }}</span
                                    >
                                </div>
                            </div>
                            ...
                            >
                                <div class="card-body">
                                    <div
                                        v-for="r in vehicle.office.filter(
                                            i => i.vehicle_id == v.id
                                        )"
                                        :key="r.id"
                                        class="timeline timeline-5 mt-1"
                                    >
                                        ...
                                        >
                                            <!--begin::Label-->
                                            <div
                                                class="timeline-label font-weight-bolder text-dark-75 font-size-lg text-right pr-3 text-nowrap"
                                            >
                                                {{ $dateEng(r.travel_date) }}
                                            </div>
                                            <!--end::Label-->
                                            <!--begin::Badge-->
                                            <div class="timeline-badge">
                                                <i
                                                    class="fa fa-genderless text-success icon-xxl"
                                                ></i>
                                            </div>
                                            <!--end::Badge-->
                                            <!--begin::Text-->
                                            <div
                                                class="timeline-content text-dark-50"
                                            >
                                                {{ r.purpose }}
                                            </div>
                                            <!--end::Text-->
